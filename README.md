...
- `scripts/export_protected_first_run_checklist.py` and
  ...
  change/rollback/incident/backup references, expected artifact groups, and
  certification owner coverage under `deploy/runtime/protected-first-run/`.
...
- `scripts/export_protected_evidence_retention_manifest.py` and
  `make protected-evidence-retention` fingerprint the final protected decision,
  sign-off package, release-readiness, certification matrix, artifact summary,
  release-retention evidence, and post-upload GitHub artifact metadata into
  `protected-evidence-retention-manifest.json` under
  `deploy/runtime/protected-evidence-retention/`.
- `scripts/export_protected_sidecar_verification.py` and
  `make protected-sidecar-verification` validate the protected metadata sidecar
...
- `scripts/export_protected_release_archive_manifest.py` and
  `make protected-release-archive` correlate GitHub artifact metadata,
  retention evidence, sidecar verification, replay, evidence index, closure

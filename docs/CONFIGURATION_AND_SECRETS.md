...
| Protected POS matrix | `TIJARA_PROTECTED_E2E_MATRIX`, `TIJARA_RUN_POS_UI_E2E`, `TIJARA_RUN_DIRECT_POS_CLICKTHROUGH`, `TIJARA_RUN_DIRECT_POS_VALIDATE_E2E`, `TIJARA_RUN_DIRECT_REFUND_FORM_E2E`, `TIJARA_RUN_MOBILE_OFFLINE_E2E`, `TIJARA_PROTECTED_POS_MATRIX_REQUIRED_WORKFLOWS`, `TIJARA_PROTECTED_POS_MATRIX_REQUIRE_BROWSER_MATRIX`, `TIJARA_PROTECTED_POS_MATRIX_STRICT`, `TIJARA_PROTECTED_POS_MATRIX_FAIL_ON_WARNING`, `TIJARA_PROTECTED_POS_MATRIX_ALLOW_LOCAL` | Odoo login/database credentials, seeded POS user password, and any hardware bridge shared secret stay in GitHub environment secrets or the selected secret manager. Strict staging/production should keep local evidence disabled. |

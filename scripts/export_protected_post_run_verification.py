...
ARTIFACT_PATHS = {
    ...
    "protected-runner-bootstrap-verification": "protected-runner-bootstrap-verification/{run_id}",
    "protected-service-checks": "protected-service-checks/{run_id}",
    "protected-provider-readiness": "protected-provider-readiness/{run_id}",
    "protected-payment-lifecycle": "protected-payment-lifecycle/{run_id}",
    "protected-offline-replay": "protected-offline-replay/{run_id}",
    "protected-offline-pilot": "protected-offline-pilot/{run_id}",
    "protected-pos-matrix": "protected-pos-matrix/{run_id}",
    "release-evidence": "release-evidence/{run_id}",
    "protected-e2e": "protected-e2e/{run_id}",
    "browser-e2e-matrix": "browser-e2e-matrix/{run_id}",
    ...
    "monitoring-evidence": "monitoring-evidence/{run_id}",
    "incident-runbook-evidence": "incident-runbooks/{run_id}",
    "secret-runtime-evidence": "secret-runtime-evidence/{run_id}",
    "deployment-environment-evidence": "deployment-environments/{run_id}",
    "tenant-ops-evidence": "tenant-ops-evidence/{run_id}",

...
INTERESTING_JSON_NAMES = {
    ...
    "protected-runner-bootstrap-verification.json",
...
def main():
    ...
    if not artifact_paths:
        artifact_paths = [
            ...
            "deploy/runtime/protected-runner-bootstrap-verification/%s" % args.run_id,
            ...
            "deploy/runtime/protected-offline-pilot/%s" % args.run_id,

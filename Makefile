...
upgrade-pkr-gst:
	$(COMPOSE) run --rm odoo bash /usr/local/bin/tijara-start-odoo -d $(DB) -u tijara_base,tijara_retail_core,tijara_pos_experience,tijara_analytics,tijara_demo_pos --without-demo --stop-after-init
